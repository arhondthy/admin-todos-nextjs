...
import { addProductToCart, getCookieCart, removeProductFromCart } from "@/shoping-cart/actions/actions";
...
export const ProductCard = ({ id, name, price, rating, image }: Props) => {
    ...
    return (
        <div className="bg-white shadow rounded-lg max-w-sm dark:border-gray-100">
