...
import { addProductToCart, removeSingleItemromCart } from "../actions/actions";
...
export const ItemCard = ({ product, quantity }: Props) => {
    ...
    function onRemoveItem() {
        removeSingleItemromCart(product.id)
        router.refresh();
    }

    return (
        <div className="flex items-center shadow rounded-lg w-full bg-gray-800 ">
